...
autosnips = {
  ...
  s({ trig = ">>", name = "much greater than ≫", wordTrig = false }, { t "\\gg " }, { condition = tex.in_mathzone }),
  ...
  s({ trig = "__", name = "subscript", wordTrig = false }, { t "_{", i(1), t "}" }, { condition = tex.in_mathzone }),
  s({ trig = "^^", name = "supscript", wordTrig = false }, { t "^{", i(1), t "}" }, { condition = tex.in_mathzone }),
  ...
  s({ trig = "FF", wordTrig = false, name = "Hirzebruch 𝔽" }, { t "\\mathbb{F}" }, { condition = tex.in_mathzone }),
  s({ trig = "HH", wordTrig = false, name = "half plane ℍ" }, { t "\\mathbb{H}" }, { condition = tex.in_mathzone }),
  ...
  s({ trig = "PP", wordTrig = false, name = "projective ℙ" }, { t "\\mathbb{P}" }, { condition = tex.in_mathzone }),
  ...
  s({ trig = "==", name = "align equls", wordTrig = false }, { t "&= " }, { condition = tex.in_align }),
  s({ trig = "ar", name = "normal arrows" }, { t "\\ar[", i(1), t "]" }, { condition = tex.in_xymatrix }),
